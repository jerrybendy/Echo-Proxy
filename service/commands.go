...
func addHostsRecordCommand() error {
	...
	data := bytes.NewBufferString("\n# Auto generated by local proxy")
	for _, h := range config.Hosts {
		if h.ApplyHosts {
			_, err = data.WriteString("\n127.0.0.1 " + h.Name + " # Auto generated by local proxy")
			_, err = data.WriteString("\n::1 " + h.Name + " # Auto generated by local proxy")
			if err != nil {
				return err
			}
		}
...
func removeHostsRecordCommand() error {
	...
	for _, line := range lines {
		if !strings.Contains(line, "# Auto generated by local proxy") {
